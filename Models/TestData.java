...
public class TestData {
    ...
    public ArrayList<Customer> seedCustomers()
    {
        ...
        customer = new Customer(4, "Anirban", "Mitra", "46,Dhanmondi", "Dhaka", "Bangladesh", 1209, 9876, "AnirbanArka21", new Long("1234567890").longValue());
        customers.add(customer);
    ...
    public ArrayList<Account> seedAccounts()
    {
        ...
        account = new CheckingAccount(799102, 1500.00, 1, "2017-02-19 22:00:00", 4);
        accounts.add(account);
        
        saving = new SavingsAccount(2302203, 100000, 2, "2017-02-23 10:59:00", 4);
        accounts.add(saving);
